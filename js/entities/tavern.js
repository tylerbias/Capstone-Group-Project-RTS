game.Tavern = game.BasicProductionBuilding.extend({
    ...
    init : function(x, y, team, teamContainer) {
    	if (team === 'yellow') {
        	var image = me.loader.getImage("tavern_yellow");
        }
        else if (team === 'blue') {
        	var image = me.loader.getImage("tavern_blue");
        }
        else if (team === 'red') {
        	var image = me.loader.getImage("tavern_red");
        }
        else if (team === 'green') {
        	var image = me.loader.getImage("tavern_green");
        }
		...
		this.teamContainer.numTavern++;

		this.spawnId = this._super(game.BasicProductionBuilding, 'spawnUnit', ['Recruit', 10000, 8*this.teamContainer.numTavern, 
																				this.pos.x, this.pos.y, this.team, this.teamContainer, "numTavern"]);
   },
